...
def analyze_commodity(symbol, data, capital, risk_per_trade):
    try:
        ...
        plot_feature_importance(models['1d'], X.columns, "Feature Importance - 1d Horizon")
...
def provide_beginner_summary(symbol, predictions, confidences, current_price, scores):
    ...
    for horizon in ['1d', '5d', '20d']:
        print(f"\n{horizon} Prediction:")
        print(f"The model suggests to {predictions[horizon]}")
        print(f"with {confidences[horizon]:.2f} confidence.")
